...
* Created Budget to queries, routers, and main.py
* Created a foreign key connecting authentication table to trips table.

Ah-ha!:
* How to create foreign keys, and understanding the relationship between our tables.
...
* Forgot to make an entry as a team *
